---
title: metaFirst — for researchers
---
...
1. **Log in** via the web interface your lab lead will share with you
   (a local URL, typically on the lab network).
2. **Pick your project** from the sidebar.
3. **Add samples** — either create them by hand or let the file watcher
   suggest new ones when data appears in a watched folder.
4. **Fill in the metadata** the form asks for. The fields are defined by
